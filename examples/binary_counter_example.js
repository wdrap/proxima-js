...
console.log(p.predict([0,0,0]).flatten)
console.log(p.predict([0,0,1]).flatten)
console.log(p.predict([0,1,0]).flatten)
console.log(p.predict([0,1,1]).flatten)
console.log(p.predict([1,0,0]).flatten)
console.log(p.predict([1,0,1]).flatten)
console.log(p.predict([1,1,0]).flatten)
console.log(p.predict([1,1,1]).flatten)
